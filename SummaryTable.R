...
# Final table showing how the CWIFT compares to amount of environmental education in each state 
education_cwift_table <- left_join(education_table, cwift_by_state, by = "State")
