...
computer_poverty <- ggplot(data = chart_data, climate_op_data) +
  geom_point(
    mapping = aes(x = happening, y = CDP03_54pct),
    color = "dodgerblue4",
    alpha = .6
  ) +
  ...
  labs(
    ...
    x = "Percentage of People Who Believe Climate Change is Happening", # x-axis label
